...
--        ["r"] = {
--          function()
--            tbi.lsp_references({ fname_width = 80 })
--          end,
--          "Show references",
--          mode = {
--            "n",
...
--        ["d"] = {
--          function()
--            tbi.lsp_definitions({ jump_type = "vsplit", fname_width = 80 })
--          end,
--          "Go to definition",
--          mode = { "n" },
--        },
--        ["t"] = {
--          function()
--            tbi.lsp_type_definitions({ fname_width = 80 })
--          end,
...
--        ["i"] = {
--          function()
--            tbi.lsp_implementations({ fname_width = 80 })
--          end,
