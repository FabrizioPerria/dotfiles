function open_build_terminal_java()
    vim.cmd("botright 10split") -- Open a split at the bottom
    vim.cmd("terminal ./gradlew build -x test") -- Open terminal and run script
...
vim.api.nvim_create_autocmd({ "BufEnter", "BufWinEnter" }, {
    pattern = { "*.java", "*.gradle" },
    command = "nnoremap <buffer> <leader><leader> :wa<CR>:lua open_build_terminal_java()<CR>",
})
