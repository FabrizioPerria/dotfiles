...
export PATH="/usr/local/go/bin:~/.fnm:/opt/homebrew/bin:$HOME/.local/bin:/opt/homebrew/opt/gawk/libexec/gnubin:/opt/homebrew/opt/llvm/bin:$PATH:/opt/local/bin:$HOME/.cargo/bin"
